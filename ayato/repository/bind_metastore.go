...
func (r *PackageNameRepository) GetPkgFileName(name string) (fp string, err error) {
	return r.pkgNameStore.PackageFile(name)
}

// StorePkgFileName stores the package name and file path in the store.
func (r *PackageNameRepository) StorePkgFileName(packageName, filePath string) error {
...
func (r *PackageNameRepository) DeletePkgFileName(packageName string) error {
